...
internal fun TabsFragment.navigateToCallHistory() {
    Log.d("Click Action Detected", "History Icon Clicked")
    val action = when (findNavController().currentDestination?.id) {
        ...
        R.id.peerFragment -> R.id.action_peerFragment_to_masterCallLogsFragment
        R.id.moreFragment -> R.id.action_moreFragment_to_masterCallLogsFragment
...
internal fun TabsFragment.navigateToContacts() {
    Log.w("Click Action Detected", "Contact Icon Clicked")
    val action = when (findNavController().currentDestination?.id) {
        ...
        R.id.peerFragment -> R.id.action_peerFragment_to_masterContactsFragment
        R.id.moreFragment -> R.id.action_moreFragment_to_masterContactsFragment
...
internal fun TabsFragment.navigateToDialer() {
    Log.w("Click Action Detected", "Dialpad Icon Clicked")
    ...
    val action = when (findNavController().currentDestination?.id) {
        ...
        R.id.peerFragment -> R.id.action_peerFragment_to_dialerFragment
        R.id.moreFragment -> R.id.action_moreFragment_to_dialerFragment
...
internal fun TabsFragment.navigateToChatRooms() {
    Log.w("Click Action Detected", "chat Icon Clicked")
    ...
    val action = when (findNavController().currentDestination?.id) {
        ...
        R.id.peerFragment -> R.id.action_peerFragment_to_masterChatRoomsFragment
        R.id.moreFragment -> R.id.action_moreFragment_to_masterChatRoomsFragment
...
internal fun TabsFragment.navigateToIsPeer() {
    Log.w("Click Action Detected", "is peer Icon Clicked")

    val action = when (findNavController().currentDestination?.id) {
        R.id.masterCallLogsFragment -> R.id.action_masterCallLogsFragment_to_peerFragment
        R.id.masterContactsFragment -> R.id.action_masterContactsFragment_to_peerFragment
        R.id.dialerFragment -> R.id.action_dialerFragment_to_peerFragment
        R.id.masterChatRoomsFragment -> R.id.action_masterChatRoomsFragment_to_peerFragment
        R.id.moreFragment -> R.id.action_moreFragment_to_peerFragment
    ...
    findNavController().navigate(
        action,
        null,
        popupTo(R.id.peerFragment, true)
    )
}

internal fun TabsFragment.navigateToMore() {
    Log.w("Click Action Detected", "Settings Icon Clicked")
    val action = when (findNavController().currentDestination?.id) {
        R.id.masterCallLogsFragment -> R.id.action_masterCallLogsFragment_to_moreFragment
        R.id.dialerFragment -> R.id.action_dialerFragment_to_moreFragment
        R.id.masterChatRoomsFragment -> R.id.action_masterChatRoomsFragment_to_moreFragment
        R.id.peerFragment -> R.id.action_peerFragment_to_moreFragment
        R.id.masterContactsFragment -> R.id.action_masterContactsFragment_to_moreFragment
        else -> R.id.action_global_masterContactsFragment
    }
    ...
    findNavController().navigate(
        action,
        null,
        popupTo(R.id.moreFragment, true)
    )
}
...
internal fun SideMenuFragment.navigateToMore() {
    findNavController().navigate(
...
internal fun WelcomeFragment.navigateToLogin() { // / anujj
