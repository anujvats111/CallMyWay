...
class GenericAccountLoginFragment : GenericFragment<AssistantGenericAccountLoginFragmentBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        corePreferences.acceptEarlyMedia = false
    ...
    private fun saveUsernameDetails(user: String, password: String) {
        SharedPrefsManager.getInstance().setString(Constants.username, user)
        SharedPrefsManager.getInstance().setString(Constants.password, password)
//        Log.e("getUsername", SharedPrefsManager.getInstance().getString(Constants.username))
    }
}
