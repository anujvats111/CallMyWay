...
//                    proxyListener.onTextValueChanged("<sip:proxy1.holvox.com;transport=tcp>")
//                    Log.i("[Assistant] : $message")
//                }
            }
        }
    }
...
//            val params = accountToCheck!!.params.clone()
//            val address = Factory.instance().createAddress(newValue)
//            if (address != null) {
//                params.serverAddress = address
//                accountToCheck!!.params = params
//                transportIndex.value = accountToCheck!!.params.transport.toInt()
//                android.util.Log.e("anuj_changes", "done ha")
//            } else {
...
//        loginEnabled.addSource(displayName) {
//            loginEnabled.value = isLoginButtonEnabled()
//        }
    }

    fun setTransport(transportType: TransportType) {
        Log.e("setTransport", transportType)
...
//            displayName.value.orEmpty().isNotEmpty() &&
