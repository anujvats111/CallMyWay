...
//        }
    ...
    companion object {
        fun startWebViewCall(value: String) {
            println("I love coding " + value)
            coreContext.startCall(value)
        }
    }

    override fun onStart() {
//        corePreferences.showAccountSettings
        setImage()
        super.onStart()
    }

    private fun setImage() {
        val url = Constants.IMAGE_URL + SharedPrefsManager.getInstance().getString(
            Constants.username
        )
