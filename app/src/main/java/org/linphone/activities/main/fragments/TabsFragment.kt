...
import org.linphone.activities.navigateToIsPeer
...
//        }
        ...
        binding.setIsPeerClickListener {
            when (findNavController().currentDestination?.id) {
                R.id.masterContactsFragment -> sharedViewModel.updateContactsAnimationsBasedOnDestination.value = Event(
                    R.id.masterCallLogsFragment
                )
    ...
    override fun onDestinationChanged(
        ...
        if (corePreferences.enableAnimations) {
            when (destination.id) {
                ...
                R.id.peerFragment -> binding.motionLayout.transitionToState(R.id.peer)
            }
        } else {
            Log.d("Destination Change Detected", destination.id.toString())
            when (destination.id) {
                ...
                R.id.dialerFragment -> {
                    ...
                    Log.d("Motion Layout Visibility", binding.motionLayout.visibility.toString())
                }
...
//                    R.id.chat_rooms
//                )
//                R.id.peerFragment -> binding.motionLayout.setTransition(R.id.peer, R.id.peer)
//            }
        }
    }
}
