...
class AccountSettingsFragment : GenericSettingFragment<SettingsAccountFragmentBinding>() {
    ...
    private lateinit var settingsListener: SettingListenerStub
    val proxyListener = null
...
//        settingsListener = SettingListenerStub()

//        binding.edtProxy.setText("<sip:proxy1.holvox.com;transport=tcp>")
//
//        binding.edtProxy.addTextChangedListener(object : TextWatcher {
...
//        binding.ivUpdateProxy.setOnClickListener {
//            <sip:proxy1.holvox.com;transport=tcp>
//            viewModel.proxyListener.onTextValueChanged(binding.edtProxy.text.toString())

//            settingsListener.onTextValueChanged(binding.edtProxy.text.toString())
        //            Toast.makeText(
//                activity,
//                "" + account.toString(),
//                Toast.LENGTH_SHORT
