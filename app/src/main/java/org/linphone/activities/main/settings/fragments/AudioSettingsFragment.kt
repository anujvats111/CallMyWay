...
//            if (payload.mimeType == "speex" || payload.mimeType == "opus") {
//                binding.setVariable(BR.enabled, false)
//            }
//            Log.e("abcdd", payload.mimeType + " " + payload.clockRate + " " + payload.enabled())
...
//        Log.e("abcdd", Gson().toJson(viewModel.audioCodecs.value))
