...
//            Log.e("abcdd",proxy.value.toString())
        }
    }
...
//                android.util.Log.e("anuj_changes1", newValue)
//                android.util.Log.e("anuj_changes2", gson.toJson(params))
//                android.util.Log.e("anuj_changes3", gson.toJson(account.params.identityAddress))
//                android.util.Log.e("anuj_changes4", gson.toJson(params.serverAddress.toString()))
                android.util.Log.e("anuj_changes2", transportIndex.value.toString())
//                android.util.Log.e("anuj_changes3", address.toString())
//                android.util.Log.e("anuj_changes", prefs.voiceMailUri.toString())
//                android.util.Log.e("anuj_changes", prefs.voiceMailUri.toString())
            } else {
...
//        android.util.Log.e("anuj_changes",
//        var outboundProxyVal = params.serverAddress?.asStringUriOnly().toString()
//        var displayName = displayName.value.toString()
//        outboundProxyVal = outboundProxyVal.replace(displayName, "proxy1")
//        proxy.value = "<$outboundProxyVal>"
//        proxy.value = "<$outboundProxyVal>"
        outboundProxy.value = true
        prefs.keepServiceAlive = false; // / anuj

        //            <sip:proxy1.holvox.com;transport=tcp>

//        proxyListener.onTextValueChanged("proxy1.holvox.com")

//        prefs.voiceMailUri = "*97"
...
//        disableBundleMode.value = !params.isRtpBundleEnabled
    ...
    interface StringChangeListener {
        fun onStringChanged(newValue: String)
    }

    class StringObservable {
        private var value: String = ""
        private val listeners: MutableList<StringChangeListener> = mutableListOf()
        ...
        fun addListener(listener: StringChangeListener) {
            listeners.add(listener)
        }

        fun removeListener(listener: StringChangeListener) {
