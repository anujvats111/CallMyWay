...
class SettingsViewModel : ViewModel() {
    ...
    init {
        ...
        if (address?.displayName.equals("Linphone Android")) {
            primaryAccountDisplayName.value = "CallMyWay Android"
        } else {
            primaryAccountDisplayName.value = address?.displayName ?: ""
        }

        if (address?.username.equals("linphone.android")) {
            primaryAccountUsername.value = "callmyway.android"
        } else {
            primaryAccountUsername.value = address?.displayName ?: ""
        }
    }
