...
//    val rightEndAnchor = MutableLiveData<Float>()
...
//        if (corePreferences.disableChat) {
//            leftAnchor.value = 1 / 5F
//            middleLeftAnchor.value = 2 / 5F
//            middleRightAnchor.value = 3 / 5F
//            middleAnchor.value = 4 / 5F
//            rightAnchor.value = 1F
//        } else {
//            leftAnchor.value = 1 / 6F
//            middleLeftAnchor.value = 2 / 6F
//            middleRightAnchor.value = 3 / 6F
//            middleAnchor.value = 4 / 6F
//            rightAnchor.value = 5 / 6F
//        }

        leftAnchor.value = 1 / 4F
//        middleLeftAnchor.value = 2 / 4F
//        middleRightAnchor.value = 3 / 4F
        middleAnchor.value = 2 / 4F
        rightAnchor.value = 3 / 4F
